...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="assets-vano/css/perfect-scrollbar.min.css" />
        <link rel="stylesheet" type="text/css" media="screen" href="assets-vano/css/style.css" />
        <link defer rel="stylesheet" type="text/css" media="screen" href="assets-vano/css/animate.css" />
        <script src="assets-vano/js/perfect-scrollbar.min.js"></script>
        <script defer src="assets-vano/js/popper.min.js"></script>
        <script defer src="assets-vano/js/tippy-bundle.umd.min.js"></script>
        <script defer src="assets-vano/js/sweetalert.min.js"></script>
    </head>
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div x-data="auth">
                <div class="absolute inset-0">
                    <img src="assets-vano/images/auth/bg-gradient.png" alt="image" class="h-full w-full object-cover" />
                </div>
                <div
                ...
                >
                    <img src="assets-vano/images/auth/coming-soon-object1.png" alt="image" class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                    <img src="assets-vano/images/auth/coming-soon-object2.png" alt="image" class="absolute left-24 top-0 h-40 md:left-[30%]" />
                    <img src="assets-vano/images/auth/coming-soon-object3.png" alt="image" class="absolute right-0 top-0 h-[300px]" />
                    <img src="assets-vano/images/auth/polygon-object.svg" alt="image" class="absolute bottom-0 end-[28%]" />
                    <div
                        ...
                        >
                            ...
                            <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                <a href="/" class="w-48 block lg:w-72 ms-10">
                                    <img src="assets-vano/images/auth/logo-white.svg" alt="Logo" class="w-full" />
                                </a>
                                <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                    <img src="assets-vano/images/auth/register.svg" alt="Cover Image" class="w-full" />
                                </div>
                            </div>
                        </div>
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            <div class="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                                <a href="index.html" class="block w-8 lg:hidden">
                                    <img src="assets-vano/images/logo.svg" alt="Logo" class="w-full" />
                                </a>
                                <div class="dropdown ms-auto w-max" x-data="dropdown" @click.outside="open = false">
                                    ...
                                    >
                                        <div>
                                            <img
                                                :src="`assets-vano/images/flags/${$store.app.locale.toUpperCase()}.svg`"
                                                alt="image"
                                        ...
                                        <template x-for="item in languages">
                                            <li>
                                                ...
                                                >
                                                    <img
                                                        class="h-5 w-5 rounded-full object-cover"
                                                        :src="`assets-vano/images/flags/${item.value.toUpperCase()}.svg`"
                                                        alt="image"
                                                    />
                                ...
                                <form class="space-y-5 dark:text-white"method="POST" action="{{ route('register') }}">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="name" name="name" type="text" placeholder="Enter Name" class="form-input ps-10 placeholder:text-white-dark" />
...
<div>
                                ...
                                <div class="text-center dark:text-white">
                                    ...
                                    <a href="auth-cover-login.html" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white"
                                        >SIGN IN</a
                                    >
                                </div>
                            </div>
        ...
        <script src="assets-vano/js/alpine-collaspe.min.js"></script>
        <script src="assets-vano/js/alpine-persist.min.js"></script>
        <script defer src="assets-vano/js/alpine-ui.min.js"></script>
        <script defer src="assets-vano/js/alpine-focus.min.js"></script>
        <script defer src="assets-vano/js/alpine.min.js"></script>

        <script src="assets-vano/js/custom.js"></script>
