...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="assets-baru/image/png" href="assets-baru/images/favicon.png" />

    <!-- CSS Assets -->
    <link rel="stylesheet" href="assets-baru/css/app.css" />

    <!-- Javascript Assets -->
    <script src="assets-baru/js/app.js" defer></script>
            ...
            <div class="flex pt-4">
              <a href="/">
                <img
                  ...
                  src="assets-baru/images/app-logo.svg"
                  alt="logo"
                />
              </a>
            </div>
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              ...
              >
                ...
                >
                  <img
                    class="rounded-full"
                    src="assets-baru/images/200x200.png"
                    alt="avatar"
                  />
                  <span
                    ...
                    <div class="tab-content flex flex-col overflow-hidden">
                      ...
                      >
                        <div class="mt-8 pb-8 text-center">
                          <img
                            class="mx-auto w-36"
                            src="assets-baru/images/illustrations/empty-girl-box.svg"
                            alt="image"
                          />
                          <div class="mt-5">
                            <p
                  ...
                  <div class="swiper-wrapper">
                    ...
                    >
                      <div class="grow">
                        <img
                          class="h-3"
                          src="assets-baru/images/payments/cc-visa-white.svg"
                          alt="image"
                        />
                      </div>
                ...
                <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                  <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                    <div class="flex items-center space-x-2">
                      <img
                        class="h-10 w-10"
                        src="assets-baru/images/100x100.png"
                        alt="image"
                      />
                      <div>
                        <h2
              ...
              <div class="mt-4">
                ...
                <div class="mt-3 space-y-3 px-2">
                  ...
                  >
                    ...
                    <img
                      src="assets-baru/images/800x600.png"
            ...
            >
              ...
              >
                <div class="flex items-center space-x-3">
                  <img
                    ...
                    src="assets-baru/images/illustrations/lms-ui.svg"
                    alt="image"
                  />
                  <div>
                    <p
              ...
              >
                <div class="flex items-center space-x-3">
                  <img
                    class="h-10 w-10 rounded-lg object-cover object-center"
                    src="assets-baru/images/illustrations/store-ui.svg"
                    alt="image"
                  />
                  <div>
                    <p
              ...
              >
                <div class="flex items-center space-x-3">
                  <img
                    class="h-10 w-10 rounded-lg object-cover object-center"
                    src="assets-baru/images/illustrations/chat-ui.svg"
                    alt="image"
                  />
                  <div>
                    <p
              ...
              >
                <div class="flex items-center space-x-3">
                  <img
                    class="h-10 w-10 rounded-lg object-cover object-center"
                    src="assets-baru/images/illustrations/nft.svg"
                    alt="image"
                  />
                  <div>
                    <p
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="whitespace-nowrap py-2">
                      <div class="flex items-center space-x-2">
                        <div
                          class="h-3.5 w-3.5 rounded-full border-2 border-success"
                        ></div>
                        <p
                          class="font-medium tracking-wide text-slate-700 dark:text-navy-100"
                        >
                  ...
                  <tr>
                    <td class="whitespace-nowrap py-2">
                      <div class="flex items-center space-x-2">
                        <div
                          class="h-3.5 w-3.5 rounded-full border-2 border-info"
                        ></div>
                        <p
                          class="font-medium tracking-wide text-slate-700 dark:text-navy-100"
                        >
                  ...
                  <tr>
                    <td class="whitespace-nowrap py-2">
                      <div class="flex items-center space-x-2">
                        <div
                          class="h-3.5 w-3.5 rounded-full border-2 border-warning"
                        ></div>
                        <p
                          class="font-medium tracking-wide text-slate-700 dark:text-navy-100"
                        >
                  ...
                  <tr>
                    <td class="whitespace-nowrap py-2">
                      <div class="flex items-center space-x-2">
                        <div
                          class="h-3.5 w-3.5 rounded-full border-2 border-error"
                        ></div>
                        <p
                          class="font-medium tracking-wide text-slate-700 dark:text-navy-100"
                        >
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
              ...
              <div class="grow">
                ...
                <div class="mt-2 flex flex-wrap">
                  ...
                  >
                    <div
                      class="h-2 w-2 rounded-full bg-primary dark:bg-accent"
                    ></div>
              ...
              <div class="flex justify-between">
                <div class="flex space-x-2">
                  <img
                    ...
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-19.svg"
                    alt="avatar"
                  />
                  <img
                    x-tooltip="'Award Level 2'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-2.svg"
                    alt="avatar"
                  />
                  <img
                    x-tooltip="'Award Level 3'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-5.svg"
                    alt="avatar"
                  />
                </div>
                <button
              ...
              <div class="flex justify-between">
                <div class="flex space-x-2">
                  <img
                    x-tooltip="'Award Level 1'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-1.svg"
                    alt="avatar"
                  />
                  <img
                    x-tooltip="'Award Level 2'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-6.svg"
                    alt="avatar"
                  />
                  <img
                    x-tooltip="'Award Level 3'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-9.svg"
                    alt="avatar"
                  />
                </div>
                <button
              ...
              <div class="flex justify-between">
                <div class="flex space-x-2">
                  <img
                    x-tooltip="'Award Level 2'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-14.svg"
                    alt="avatar"
                  />
                  <img
                    x-tooltip="'Award Level 3'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-13.svg"
                    alt="avatar"
                  />
                </div>
                <button
              ...
              <div class="flex justify-between">
                <div class="flex space-x-2">
                  <img
                    x-tooltip="'Award Level 2'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-15.svg"
                    alt="avatar"
                  />
                  <img
                    x-tooltip="'Award Level 3'"
              ...
              <div class="flex justify-between">
                <div class="flex space-x-2">
                  ...
                  <img
                    x-tooltip="'Award Level 3'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-25.svg"
                    alt="avatar"
                  />
                </div>
                <button
              ...
              <div class="flex justify-between">
                <div class="flex space-x-2">
                  ...
                  <img
                    x-tooltip="'Award Level 3'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-24.svg"
                    alt="avatar"
                  />
                  <img
                    x-tooltip="'Award Level 3'"
                    class="h-6 w-6"
                    src="assets-baru/images/awards/award-30.svg"
                    alt="avatar"
                  />
                </div>
                <button
